...
@Service
public class DefaultPharmacyService implements PharmacyService {

    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultPharmacyService.class);

    private final PharmacyRegistry registry;
    private final BdaGateway bdaGateway;
    private final PharmacyRepository repository;

    public DefaultPharmacyService(PharmacyRegistry registry,
